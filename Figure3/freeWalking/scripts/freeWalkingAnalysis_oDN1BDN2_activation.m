...
OFFTrial3 = trial3(1):ON3(1)+trialDuration*fps -1;
OFFTrial4 = trial4(1):ON4(1)+trialDuration*fps -1;
%OFFTrial5 = trial5(1):ON5(1)+trialDuration*fps -1;
...
for i = 1:length(realSubFolders)
    ...
    % Since Trk and Feat files created seperately do if statement once more
        ...
        data(i).perFlyData(j).medianVelTrial1 = median(data(i).perFlyData(j).smoothVelTrial1(:,301:600),2);
        data(i).perFlyData(j).smoothVelTrial2 = data(i).perFlyData(j).smoothVel(trial2);
        data(i).perFlyData(j).medianVelTrial2 = median(data(i).perFlyData(j).smoothVelTrial2(:,301:600),2);
        data(i).perFlyData(j).smoothVelTrial3 = data(i).perFlyData(j).smoothVel(trial3);
        data(i).perFlyData(j).medianVelTrial3 = median(data(i).perFlyData(j).smoothVelTrial3(:,301:600),2);
        data(i).perFlyData(j).smoothVelTrial4 = data(i).perFlyData(j).smoothVel(trial4);
        data(i).perFlyData(j).medianVelTrial4 = median(data(i).perFlyData(j).smoothVelTrial4(:,301:600),2);
        data(i).perFlyData(j).smoothVelTrial5 = data(i).perFlyData(j).smoothVel(trial5);
        data(i).perFlyData(j).medianVelTrial5 = median(data(i).perFlyData(j).smoothVelTrial5(:,301:600),2);
